...
module.exports = Addon.extend({
  ...
  _treeForParentAppTemplates: function() {
    const templatePath = path.join(this.parent.root, 'app', 'templates');
  ...
  _treeForParentAddonTemplates: function() {
    const templatePath = path.join(this.parent.root, 'addon', 'templates');
  ...
  _treeForTranslatedProperties: function() {
    ...
    if (existsSync(i18nPath)) {
      ...
      this.treeCache['_treeForTranslatedProperties'] = new Funnel(new UnwatchedDir(i18nPath), {
