...
module.exports = Addon.extend({
   ...
   */
  _treeForTranslation: memoize(function treeForTranslation() {
    var trees = [
  ...
  _treeForTranslatedProperties: memoize(function treeForTranslatedProperties() {
  ...
  _collectTranslationTrees: memoize(function collectTranslationTrees() {
